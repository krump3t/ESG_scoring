...
class GHGMatcher(BaseMatcher):
    ...
    def __init__(self):
        ...
        patterns = {
            ...
            # Assurance level
            "limited_assurance": r"\blimited\s+assurance\b.*?(emissions?|GHG|inventory|carbon)",
            "reasonable_assurance": r"\breasonable\s+assurance\b.*?(emissions?|GHG|inventory|carbon)",

            # Assurance providers (Big 4 + common providers)
            "assurance_provider_deloitte": r"\bDeloitte\b.{0,50}(assurance|verification|audit).{0,50}(emissions?|GHG)",
            "assurance_provider_ey": r"\b(EY|Ernst\s+&\s+Young)\b.{0,50}(assurance|verification|audit).{0,50}(emissions?|GHG)",
            "assurance_provider_kpmg": r"\bKPMG\b.{0,50}(assurance|verification|audit).{0,50}(emissions?|GHG)",
            "assurance_provider_pwc": r"\b(PwC|PricewaterhouseCoopers)\b.{0,50}(assurance|verification|audit).{0,50}(emissions?|GHG)",
